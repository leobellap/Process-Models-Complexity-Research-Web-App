...
function preloadImages() {
  for (var step = 0; step < gridSize; step += 1) {
    for (var difficulty = 0; difficulty < gridSize; difficulty += 1) {
      var src = `/static/images/models/Dataset_3/Dataset-3_AR-${step}0_PR/Dataset-3_AR-${step}0_PR-${difficulty}0.svg`;
...
function updateImage(x, y) {
  var src = `/static/images/models/Dataset_3/Dataset-3_AR-${x}0_PR/Dataset-3_AR-${x}0_PR-${y}0.svg`;
  if (imageCacheIntOp[src]) {
